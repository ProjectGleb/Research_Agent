...
# I changed the mx section to 5, follow_fuidelines to true and a few guidelines.
# Use docker. ?
# Can you change the design after using docer? 
from dotenv import load_dotenv
import sys
import os
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))
inp = input("What would you like to conduct research on?: ")
